"""
Unified model definitions for centralized and federated learning.
...
ALL models work identically across centralized and federated (FedAvg) settings.
No per-dataset or per-client model variations.
"""
